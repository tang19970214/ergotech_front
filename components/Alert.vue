<template>
  <transition name="closeAlert">
    <div class="w-full h-screen fixed inset-0 z-50 alertFixed"  v-if="openAlert">
        <div class="alert">
            <div class="top"></div>
            <div class="body">
                <div class="py-1">
                    ...
                    <div>
                        <p class="font-bold">完成</p>
                    </div>
                </div>

                <!--footer-->
                <div class="footer">
                    <button class="bg-primary py-1 px-3 text-sm font-medium text-white rounded-sm" @click="closeAlert()">確定</button>
                </div>
            </div>
        </div>
    </div>
